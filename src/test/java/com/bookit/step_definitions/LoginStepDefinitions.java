...
public class LoginStepDefinitions {
	...
	public void the_user_logs_in_as_ateacher() {
	...
	public void they_is_now_doing_whatever_he_wants() {
		System.out.println("I did whatever I want!!");
	}

	@Then("no one is stopping him")
	public void no_one_is_stopping_him() {
		System.out.println("no body stoped him!!");
	}
